...
CREATE TABLE IF NOT EXISTS `field_about_repeater` (
...
-- Dumping data for table docker.field_about_repeater: 1 rows
DELETE FROM `field_about_repeater`;
/*!40000 ALTER TABLE `field_about_repeater` DISABLE KEYS */;
INSERT INTO `field_about_repeater` (`pages_id`, `data`, `count`, `parent_id`) VALUES
	(1024, '1064,1065', 2, 1063);
/*!40000 ALTER TABLE `field_about_repeater` ENABLE KEYS */;
...
-- Dumping data for table docker.field_brand: 5 rows
...
INSERT INTO `field_content` (`pages_id`, `data`, `data1020`) VALUES
	...
	(1029, '<p>Our range of medical devices includes high-quality <strong>thermometers</strong> and <strong>sphygmomanometers</strong>, ideal for precise health monitoring at home or in professional settings.</p>', ''),
	(1056, '<p>Beskontaktni infracrveni toplomjer Vaše je rješenje ako tražite brzo i pouzdano mjerenje temperature. Osim tjelesne temperature, u posebnom načinu rada mjeri temperaturu tekućina te objekata.</p>', ''),
...
-- Dumping data for table docker.field_process: 26 rows
...
-- Dumping structure for table docker.field_products_on_homepage
DROP TABLE IF EXISTS `field_products_on_homepage`;
CREATE TABLE IF NOT EXISTS `field_products_on_homepage` (
  `pages_id` int(10) unsigned NOT NULL,
  `data` int(11) NOT NULL,
  `sort` int(10) unsigned NOT NULL,
  PRIMARY KEY (`pages_id`,`sort`),
...
-- Dumping data for table docker.field_products_on_homepage: 3 rows
DELETE FROM `field_products_on_homepage`;
/*!40000 ALTER TABLE `field_products_on_homepage` DISABLE KEYS */;
...
-- Dumping data for table docker.field_seo_description: 8 rows
...
-- Dumping data for table docker.field_seo_title: 8 rows
...
-- Dumping data for table docker.field_short_description: 3 rows
...
INSERT INTO `field_short_description` (`pages_id`, `data`, `data1020`) VALUES
	...
	(1064, '<p>Misija Propharma je, kao bitan dio primarne zdravstvene zaštite, pacijentima pružiti vrhunske farmaceutske usluge u prevenciji bolesti i farmakoterapiji uz istovremeno podizanje svijesti o važnosti dobrobiti svakog pojedinca. Kako bismo ostvarili svoju misiju, oslanjat ćemo se na znanje i stručnost naših zaposlenika te njihovo veliko međunarodno i profesionalno iskustvo.</p>', ''),
	(1065, '<p>Vizija Propharme je biti moderna boutique farmaceutska tvrtka koja doprinosi regionalnom zdravstvenom sustavu pružanjem lijekova s ​​dodanom vrijednošću i pridonošenjem cjenovne dostupnosti najpotrebnijih terapija.</p>', '');
...
-- Dumping data for table docker.field_short_description_2: 6 rows
...
-- Dumping data for table docker.field_slika: 15 rows
...
INSERT INTO `field_slika` (`pages_id`, `data`, `sort`, `description`, `modified`, `created`, `filedata`, `filesize`, `created_users_id`, `modified_users_id`, `width`, `height`, `ratio`) VALUES
	...
	(1024, 'media.png', 0, '[""]', '2024-12-30 12:01:49', '2024-12-30 12:01:49', '', 841732, 41, 41, 1228, 692, 1.77),
...
-- Dumping structure for table docker.field_slika_2
DROP TABLE IF EXISTS `field_slika_2`;
CREATE TABLE IF NOT EXISTS `field_slika_2` (
  `pages_id` int(10) unsigned NOT NULL,
  `data` varchar(250) NOT NULL,
  `sort` int(10) unsigned NOT NULL,
  `description` text NOT NULL,
...
-- Dumping data for table docker.field_slika_2: 1 rows
DELETE FROM `field_slika_2`;
/*!40000 ALTER TABLE `field_slika_2` DISABLE KEYS */;
INSERT INTO `field_slika_2` (`pages_id`, `data`, `sort`, `description`, `modified`, `created`, `filedata`, `filesize`, `created_users_id`, `modified_users_id`, `width`, `height`, `ratio`) VALUES
	(1024, 'vrijednosti-4.png', 0, '[""]', '2024-12-30 12:01:49', '2024-12-30 12:01:49', '', 117683, 41, 41, 1170, 658, 1.78);
/*!40000 ALTER TABLE `field_slika_2` ENABLE KEYS */;
...
-- Dumping data for table docker.field_slike: 8 rows
...
INSERT INTO `field_slike` (`pages_id`, `data`, `sort`, `description`, `modified`, `created`, `filedata`, `filesize`, `created_users_id`, `modified_users_id`, `width`, `height`, `ratio`) VALUES
	(1052, 'proizvod-2.jpg', 2, '["3"]', '2024-12-30 00:27:31', '2024-12-28 23:00:02', '{"uploadName":"proizvod.jpg"}', 50159, 41, 41, 627, 627, 1.00),
	(1052, 'proizvod.jpg', 0, '["1"]', '2024-12-30 00:27:20', '2024-12-28 23:00:02', '', 50159, 41, 41, 627, 627, 1.00),
	(1052, 'proizvod-1.jpg', 1, '["2"]', '2024-12-30 00:27:24', '2024-12-28 23:00:02', '{"uploadName":"proizvod.jpg"}', 50159, 41, 41, 627, 627, 1.00),
	(1059, 'proizvod5.jpg', 0, '[""]', '2024-12-30 09:11:53', '2024-12-30 09:11:53', '', 83672, 41, 41, 666, 666, 1.00),
	(1057, 'proizvod3.jpg', 0, '[""]', '2024-12-30 09:08:41', '2024-12-30 09:08:41', '', 45604, 41, 41, 666, 666, 1.00),
	(1057, 'proizvod3-1.jpg', 1, '[""]', '2024-12-30 09:08:41', '2024-12-30 09:08:41', '{"uploadName":"proizvod3.jpg"}', 45604, 41, 41, 666, 666, 1.00),
	(1056, 'proizvod2.jpg', 0, '[""]', '2024-12-30 09:08:15', '2024-12-30 09:08:15', '', 20181, 41, 41, 666, 666, 1.00),
	(1058, 'proizvod4.jpg', 0, '[""]', '2024-12-30 09:11:07', '2024-12-30 09:11:07', '', 86235, 41, 41, 666, 666, 1.00);
...
-- Dumping data for table docker.field_subtitle: 2 rows
...
-- Dumping data for table docker.field_title: 87 rows
...
INSERT INTO `field_title` (`pages_id`, `data`, `data1020`) VALUES
	...
	(1064, 'Misija', ''),
	(1068, 'od 2001. godine martketing i distribucija', ''),
	(1066, 'en', ''),
	(1067, 'godina poslovanja', ''),
	(1065, 'Vizija', ''),
	...
	(1058, 'Digital blood pressure monitor for the upper arm', 'Classic toplomjer'),
	(1059, 'Digital wrist blood pressure monitor', 'Digitalni tlakomjer za zapešće'),
	(1063, 'about-propharma', ''),
	(1062, 'about_repeater', ''),
	(1069, 'više od 30 proizvoda u portfoliu', '');
...
-- Dumping data for table docker.modules: 110 rows
DELETE FROM `modules`;
...
INSERT INTO `modules` (`id`, `class`, `flags`, `data`, `created`) VALUES
	...
	(184, 'FileValidatorImage', 0, '', '2024-12-28 09:57:30'),
	(185, 'ProcessPageClone', 11, '', '2024-12-29 23:28:12');
...
) ENGINE=MyISAM AUTO_INCREMENT=1070 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- Dumping data for table docker.pages: 91 rows
DELETE FROM `pages`;
...
INSERT INTO `pages` (`id`, `parent_id`, `templates_id`, `name`, `status`, `modified`, `modified_users_id`, `created`, `created_users_id`, `published`, `sort`, `name1020`, `status1020`) VALUES
	...
	(1058, 1044, 48, 'digital-blood-pressure-monitor-for-the-upper-arm', 1, '2024-12-30 09:06:03', 41, '2024-12-30 09:09:43', 41, '2024-12-30 08:10:35', 4, 'digitalni-tlakomjer-za-nadlakticu', 1),
	...
	(1052, 1043, 48, 'infrared-forehead-thermometer', 1, '2024-12-29 23:27:34', 41, '2024-12-28 21:57:58', 41, '2024-12-28 21:58:00', 0, 'infracrveni-toplomjer-za-celo', 1),
	(1053, 3, 2, 'clone', 1024, '2024-12-29 23:28:12', 41, '2024-12-29 23:28:12', 41, '2024-12-29 23:28:12', 10, NULL, 0),
	(1054, 31, 5, 'page-clone', 1, '2024-12-29 23:28:12', 41, '2024-12-29 23:28:12', 41, '2024-12-29 23:28:12', 14, NULL, 1),
	(1055, 31, 5, 'page-clone-tree', 1, '2024-12-29 23:28:12', 41, '2024-12-29 23:28:12', 41, '2024-12-29 23:28:12', 15, NULL, 1),
	(1056, 1043, 48, 'non-contact-thermometer', 1, '2024-12-30 09:06:31', 41, '2024-12-30 00:28:24', 41, '2024-12-29 23:29:43', 1, 'beskontaktni-toplomjer', 1),
	(1057, 1043, 48, 'classic-thermometer', 1, '2024-12-30 08:08:41', 41, '2024-12-30 00:30:38', 41, '2024-12-29 23:31:01', 2, 'classic-toplomjer', 1),
	(1059, 1044, 48, 'digital-wrist-blood-pressure-monitor', 1, '2024-12-30 09:06:17', 41, '2024-12-30 09:09:46', 41, '2024-12-30 08:11:42', 3, 'digitalni-tlakomjer-za-zapesce', 1),
...
-- Dumping data for table docker.pages_access: 53 rows
...
INSERT INTO `pages_access` (`pages_id`, `templates_id`, `ts`) VALUES
	...
	(1068, 2, '2024-12-30 12:42:21'),
	(1034, 2, '2024-12-28 08:14:38'),
	(1067, 2, '2024-12-30 12:41:38'),
	(1065, 2, '2024-12-30 11:03:04'),
	...
	(1054, 2, '2024-12-29 23:28:12'),
	(1055, 2, '2024-12-29 23:28:12'),
	(1056, 1, '2024-12-29 23:28:24'),
	(1057, 1, '2024-12-29 23:30:38'),
	(1058, 1, '2024-12-30 08:09:43'),
	(1059, 1, '2024-12-30 08:09:46'),
	(1064, 2, '2024-12-30 11:02:46'),
	(1069, 2, '2024-12-30 12:42:28');
...
-- Dumping data for table docker.pages_parents: 47 rows
